...
const ROUTES = Object.freeze({
    ...
    COVID: {
        ...
        LETTER: {
            ...
            NEW: {
                MAIN: `${THEME_COVID_PATH}/letter/new/[option]`, //편지 본문 작성 페이지
                STICKER: `${THEME_COVID_PATH}/letter/new/[option]/sticker`, //편지 스티커 선택 페이지
                FINISH: `${THEME_COVID_PATH}/letter/new/[option]/finish`, //편지 발송 완료 페이지
            },
        },
    },
})
